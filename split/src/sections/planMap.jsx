...
import { PlanningOverlay } from "../components/mapArtwork.jsx";
import { MAP_IMAGES } from "../data/maps.js";

/* the three things the planner's overlay draws, in the order they appear */
const MAP_LEGEND = [
...
export default function PlanMap({ routes, totalRouteCount }) {
  return (
    <>
      <MapPanel
