...
import { PoiCrop } from "../components/mapArtwork.jsx";
import SectionHeading from "../components/sectionHeading.jsx";
import { MAP_IMAGES } from "../data/maps.js";
import { POI_PATH } from "../data/navigation.js";
import { filterPointsOfInterest } from "../data/pointsOfInterest.js";
...
export default function PointsOfInterestPreview() {
  const highlights = filterPointsOfInterest({
    query: "",
    category: "all",
    sort: "rating",
  }).slice(0, POI_PREVIEW_COUNT);
