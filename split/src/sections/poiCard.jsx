...
import { formatDistance, formatRating } from "../format.js";
import { poiCategoryIcon } from "../data/pointsOfInterest.js";

export default function PoiCard({ point, selected, onSelect }) {
  return (
    <article
